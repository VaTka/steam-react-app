...
const Header = () => {
    ...
    return (
        <div className="flex py-9 px-3 items-center flex-row space-x-3">
            <img src={logo} className='h-8' alt={"steam"}/>


            <div className="relative w-full">
                <input className="py-3 text-white bg-[#837F7F] rounded-2xl pl-4 placeholder-white w-full"
            ...
            <div className="flex items-center space-x-3 w-[30%]">
                ...
                <div className="flex text-white bg-[#837F7F] rounded-2xl py-3 px-4 space-x-4 whitespace-nowrap">
